...
mp + geom_net(data= slavenet_all, layout = NULL, 
              directed = TRUE, ealpha = .1, arrowgap = 1, curvature = .2,
...
mp + geom_net(data= st1807, layout = NULL, directed = TRUE, 
              ealpha = .3, arrowgap = 1,
          aes(x=longitude, y = latitude, from_id = mjbyptimp, to_id=mjslptimp,
              color = natinimp, arrowsize = arrowsize, group = natinimp, curvature = .2)) +
  scale_color_brewer(palette = 'Set1') + 
  theme(legend.position = 'bottom') + lims(x = c(-105,75), y = c(-50,50))
@
...
mp + geom_net(data= stgb, layout = NULL, directed = TRUE, ealpha = .2, arrowgap = 1, curvature = .2,
          aes(x=longitude, y = latitude, from_id = mjbyptimp, to_id=mjslptimp,
...
mp + geom_net(data= usa_death_data, layout = NULL, 
              ealpha = .1, arrowgap = 1, directed = TRUE,color = "#ff7f00", curvature = .2,
              aes(x=longitude, y = latitude, from_id = mjbyptimp, to_id=mjslptimp,
